...
public class PullToRefreshView extends RelativeLayout {
	...
	private void changeState(int to) {
		...
		case INIT:
			...
			loadStateTextView.setText("下拉加载更多");
			pullUpView.clearAnimation();
			pullUpView.setVisibility(View.VISIBLE);
			break;
		case RELEASE_TO_REFRESH:
			// 释放刷新状态
			refreshStateTextView.setText("释放刷新");
		...
		case REFRESHING:
			...
			refreshStateTextView.setText("正在刷新ing");
			break;
		case RELEASE_TO_LOAD:
			// 释放加载状态
			loadStateTextView.setText("释放加载");
		...
		case LOADING:
			...
			loadStateTextView.setText("正在加载ing");
			break;
		case DONE:
			// 刷新或加载完毕，啥都不做
			break;
